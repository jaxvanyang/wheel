...
ResourceManager *new_resource_manager() {
	...
	manager->platform = load_texture("assets/brackeys_platformer_assets/sprites/platforms.png");
	manager->player = load_texture("assets/brackeys_platformer_assets/sprites/knight.png");
	manager->tileset = load_texture("assets/brackeys_platformer_assets/sprites/world_tileset.png");
	manager->bgm =
